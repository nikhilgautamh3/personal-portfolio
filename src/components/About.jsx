...
const About = () => {
  return (
    <div name='about' className='w-full h-screen bg-[#0e0e36] text-gray-300'>
    <div className='flex flex-col justify-center items-center w-full h-full'>
         <div className='max-w-[1000px] w-full  grid grid-cols-2 gap-8'>
            ...
            <div className='sm:text-right text-4xl font-bold '><p>Hello!! I'm Nikhil, Its a pleasure to see you. Have a look around</p></div>
            <div className='text-yellow-400 '><p>
